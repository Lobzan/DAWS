    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./index.php">Mi tienda sobre ruedas</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="./basededatos/index.php">Base de Datos</a>
                    </li>
                    <?php
                    $carrito = isset($carrito) ? $carrito : new Carrito();
                    echo $carrito->cestaMenu();?>
